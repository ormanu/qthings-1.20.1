...
public class TridentItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer, SimpleSynchronousResourceReloadListener {
    private final Identifier id;
    private final Identifier tridentId;
    private final Identifier texture;
    private final EntityModelLayer modelLayer;
    private ItemRenderer itemRenderer;
    private QTTridentModel tridentModel;
    private BakedModel inventoryTridentModel;

    public TridentItemRenderer(Identifier tridentId, Identifier texture, EntityModelLayer modelLayer) {
    ...
    public void reload(ResourceManager manager) {
        ...
        this.tridentModel = new QTTridentModel(mc.getEntityModelLoader().getModelPart(this.modelLayer));
